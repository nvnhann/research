...
def print_results(results_dic, results_stats_dic, model, 
    ...
    for key in results_stats_dic:
        # Check if the key starts with 'p' for percentage
        if key.startswith('p'):
    ...
    if print_incorrect_dogs and (results_stats_dic['n_correct_dogs'] + results_stats_dic['n_correct_notdogs'] != results_stats_dic['n_images']):
        ...
        for key in results_dic:
            # Check if the classifier function misclassified dogs
            if (results_dic[key][3] == 1 and results_dic[key][4] == 0) or (results_dic[key][3] == 0 and results_dic[key][4] == 1):
                print("Real: {:>30}   Classifier Label: {:>30}".format(results_dic[key][0], results_dic[key][1]))
    ...
    if print_incorrect_breed and (results_stats_dic['n_correct_dogs'] != results_stats_dic['n_correct_breed']):
        ...
        for key in results_dic:
            # Check if the pet label is a dog and the breed is incorrect
            if sum(results_dic[key][3:]) == 2 and results_dic[key][2] == 0:
                print("Real: {:>26}   Classifier Label: {:>30}".format(results_dic[key][0], results_dic[key][1]))
