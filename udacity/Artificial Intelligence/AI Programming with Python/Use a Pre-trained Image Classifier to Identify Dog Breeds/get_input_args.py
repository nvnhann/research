...
def get_input_args():
    ...
    parser.add_argument('--arch', type = str, choices=['vgg', 'alexnet', 'resnet'],  default='vgg', help='Model CNN')
    parser.add_argument('--dogfile', type = str, default='dognames.txt', help='dogfile')
