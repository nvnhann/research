...
# Ttake the encodedCustomer column which is base64 encoded at first like this:
# +--------------------+
# |            customer|
# +--------------------+
# |[7B 22 73 74 61 7...|
...
sql_statement = "SELECT * FROM CustomerRecords WHERE email IS NOT NULL AND birthDay IS NOT NULL"
