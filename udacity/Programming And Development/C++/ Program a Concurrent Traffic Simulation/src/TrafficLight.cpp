...
void MessageQueue<T>::send(T &&msg)
{
    ...
    // std::cout << " TrafficLightPhase message has been sent to the queue" << std::endl;
...
void TrafficLight::cycleThroughPhases()
{
    ...
    double cycleDuration = distr(eng);           // duration of a cycle in sec
    ...
    while (true)
    {
        ...
        // std::cout << timeSinceLastUpdate << " " << cycleDuration << std::endl;
...
// Explicitly define the template in the .cpp file
