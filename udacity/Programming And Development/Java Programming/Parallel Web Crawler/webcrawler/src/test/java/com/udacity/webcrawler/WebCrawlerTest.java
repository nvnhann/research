...
public final class WebCrawlerTest {
    ...
    public void testOverrideToSequential() {
        CrawlerConfiguration config = new CrawlerConfiguration.Builder()
                .setImplementationOverride(SequentialWebCrawler.class.getName()).setParallelism(12)
                .build();
    ...
    public void testOverrideToParallel() {
        CrawlerConfiguration config = new CrawlerConfiguration.Builder()
                .setImplementationOverride(ParallelWebCrawler.class.getName()).setParallelism(12)
                .build();
        Guice.createInjector(new WebCrawlerModule(config), new NoOpProfilerModule())
                .injectMembers(this);
    ...
    public void zeroMaxDepth(Class<?> crawlerClass) {
        CrawlerConfiguration config = new CrawlerConfiguration.Builder()
                .setImplementationOverride(crawlerClass.getName()).setMaxDepth(0)
                .setPopularWordCount(3)
                .addStartPages(Paths.get(DATA_DIR, "test-page.html").toUri().toString()).build();
        Guice.createInjector(new WebCrawlerModule(config), new NoOpProfilerModule())
                .injectMembers(this);
    ...
    public void noStartPages(Class<?> crawlerClass) {
        CrawlerConfiguration config =
                new CrawlerConfiguration.Builder().setImplementationOverride(crawlerClass.getName())
                        .setMaxDepth(10).setPopularWordCount(3).build();
        Guice.createInjector(new WebCrawlerModule(config), new NoOpProfilerModule())
                .injectMembers(this);
        assertThat(crawler.getClass()).isAssignableTo(crawlerClass);
    ...
    public void testBasicCrawl(Class<?> crawlerClass) {
        CrawlerConfiguration config = new CrawlerConfiguration.Builder()
                .setImplementationOverride(crawlerClass.getName()).setMaxDepth(10)
                .setPopularWordCount(3)
                .addStartPages(Paths.get(DATA_DIR, "test-page.html").toUri().toString()).build();
        Guice.createInjector(new WebCrawlerModule(config), new NoOpProfilerModule())
                .injectMembers(this);
        ...
        assertWithMessage("Returned the wrong number of popular words")
                .that(result.getUrlsVisited()).isEqualTo(3);
        assertWithMessage(
                "Returned the correct number of popular words, but the wrong words or counts")
                        .that(result.getWordCounts()).containsEntry("the", 4);
        assertWithMessage(
                "Returned the correct number of popular words, but the wrong words or counts")
                        .that(result.getWordCounts()).containsEntry("jumped", 2);
        assertWithMessage(
                "Returned the correct number of popular words, but the wrong words or counts")
                        .that(result.getWordCounts()).containsEntry("brown", 2);
    ...
    public void respectsIgnoredUrls(Class<?> crawlerClass) {
        CrawlerConfiguration config =
                new CrawlerConfiguration.Builder().setImplementationOverride(crawlerClass.getName())
                        .setMaxDepth(10).setPopularWordCount(3)
                        ...
                        .addIgnoredUrls(".*-loop\\.html$").addIgnoredUrls(".*dead-.*").build();
        Guice.createInjector(new WebCrawlerModule(config), new NoOpProfilerModule())
                .injectMembers(this);
        assertThat(crawler.getClass()).isAssignableTo(crawlerClass);
    ...
    public void respectsIgnoredWords(Class<?> crawlerClass) {
        CrawlerConfiguration config =
                new CrawlerConfiguration.Builder().setImplementationOverride(crawlerClass.getName())
                        .setMaxDepth(10).setPopularWordCount(3)
                        .addStartPages(Paths.get(DATA_DIR, "test-page.html").toUri().toString())
                        .addIgnoredWords("^...$").addIgnoredWords("^......$").build();
        Guice.createInjector(new WebCrawlerModule(config), new NoOpProfilerModule())
                .injectMembers(this);
        assertThat(crawler.getClass()).isAssignableTo(crawlerClass);
    ...
    public void respectsMaxDepth(Class<?> crawlerClass) {
        CrawlerConfiguration config = new CrawlerConfiguration.Builder()
                .setImplementationOverride(crawlerClass.getName()).setMaxDepth(1)
        ...
        assertThat(result.getWordCounts().entrySet())
                .containsExactly(Map.entry("the", 2), Map.entry("jumped", 1), Map.entry("brown", 1),
                        Map.entry("quick", 1), Map.entry("lazy", 1), Map.entry("link", 1),
                        Map.entry("over", 1), Map.entry("dog", 1), Map.entry("fox", 1))
                .inOrder();
    }
    ...
    public void pageNotFoundStillCountsAsVisited(Class<?> crawlerClass) {
        CrawlerConfiguration config = new CrawlerConfiguration.Builder()
                .setImplementationOverride(crawlerClass.getName()).setMaxDepth(10)
                .setPopularWordCount(20)
                .addStartPages(Paths.get(DATA_DIR, "link-1.html").toUri().toString()).build();
        Guice.createInjector(new WebCrawlerModule(config), new NoOpProfilerModule())
                .injectMembers(this);
        assertThat(crawler.getClass()).isAssignableTo(crawlerClass);
    ...
    public void infiniteLoop(Class<?> crawlerClass) {
        CrawlerConfiguration config =
                new CrawlerConfiguration.Builder().setImplementationOverride(crawlerClass.getName())
                        .setMaxDepth(10).setPopularWordCount(3).setTimeoutSeconds(1)
                        .addStartPages(Paths.get(DATA_DIR, "infinite-loop.html").toUri().toString())
                        .build();
        Guice.createInjector(new WebCrawlerModule(config), new NoOpProfilerModule())
                .injectMembers(this);
