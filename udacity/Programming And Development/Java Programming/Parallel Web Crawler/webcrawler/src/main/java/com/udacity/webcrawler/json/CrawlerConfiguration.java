...
public final class CrawlerConfiguration {
  ...
  private CrawlerConfiguration(List<String> startPages, List<Pattern> ignoredUrls,
      List<Pattern> ignoredWords, int parallelism, String implementationOverride, int maxDepth,
      Duration timeout, int popularWordCount, String profileOutputPath, String resultPath) {
   ...
   *
   * <p>
   * If unset or empty, the value of {@link #getParallelism()} setting is used to determine which
   ...
   *
   * <p>
   * The "depth" of a crawl is the number of links the crawler has followed, starting from the
   ...
   *
   * <p>
   * Suppose the max depth is 2, and suppose the starting page "A" links to the following web pages:
   *
   * <p>
   * 
   * <pre>
   ...
   *
   * <p>
   * In this example, the crawler will visit at most A, B, C, and D. The crawler may visit
   ...
   *
   * <p>
   * This is not a strict deadline, meaning the crawler does not have to drop everything and
   ...
   *
   * <p>
   * See {@link com.udacity.webcrawler.json.CrawlResult#getWordCounts()} for more information.
   */
   ...
   *
   * <p>
   * If a file already exists at the path, performance information should be appended to the
   * existing file.
   *
   * <p>
  ...
  public static final class Builder {
     ...
     *
     * <p>
     * Does nothing if the given page has already been added. See {@link #getStartPages()}.
     */
     ...
     *
     * <p>
     * Does nothing if the same pattern has already been added. See {@link #getIgnoredUrls()}.
     *
     ...
     *
     * <p>
     * Does nothing if the same pattern has already been added. See {@link #getIgnoredWords()}.
     *
     * <p>
     * See {@link com.udacity.webcrawler.json.CrawlResult#getWordCounts()} for more information
    ...
    public CrawlerConfiguration build() {
      ...
      return new CrawlerConfiguration(startPages.stream().collect(Collectors.toUnmodifiableList()),
          ...
          parallelism, implementationOverride, maxDepth, Duration.ofSeconds(timeoutSeconds),
          popularWordCount, profileOutputPath, resultPath);
    }
  }
}
