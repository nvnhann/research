 ...
 *
 * <p>
 * Reimplement the sort() method using only the Stream API and lambdas and/or method references.
 */
final class WordCounts {
  ...
  static Map<String, Integer> sort(Map<String, Integer> wordCounts, int popularWordCount) {
    // Stream over the entries, sort using WordCountComparator, and limit the results
